...
interface ShowcancelsucceedProps{
...
export const Showcancelsucceed= ({ transaction }: ShowcancelsucceedProps) => {
    ...
    <AnimationWrapper>
      <AnimatePresence initial={false} exitBeforeEnter>
        {showTransactionStatus && transaction.status === 'Success' && (
          <IdBlock
            color="black"
            text= {"Your payment have canceled successfully,please remember withdraw the balance" }
          />
        )}
      </AnimatePresence>
    </AnimationWrapper>
...
export const TransactionForm = ({ balance, send, title, ticker, transaction }: TransactionFormProps) => (
  <SmallContentBlock>
   ...
   { <InputComponent ticker={ticker} transaction={transaction} send={send} /> }
    ...
    <Showcancelsucceed transaction={transaction} />
  </SmallContentBlock>
)
